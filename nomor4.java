...
public class nomor4 {
    public static void main(String[] args) {
        ...
        System.out.println("Tinggi :"+limasSegiEmpat1.getLuas());
        System.out.println("Tinggi :"+limasSegiEmpat1.getVolume());
        System.out.println("");
        ...
        System.out.println("Tinggi :"+limasSegiEmpat2.getLuas());
        System.out.println("Tinggi :"+limasSegiEmpat2.getVolume());
        System.out.println("");
        ...
        System.out.println("Tinggi :"+limasSegiEmpat3.getLuas());
        System.out.println("Tinggi :"+limasSegiEmpat3.getVolume());
        System.out.println("");
